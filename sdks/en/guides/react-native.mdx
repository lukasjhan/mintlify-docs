...
1. Move the **.env** file downloaded from the console to the project folder. Or, create a **.env** file and set the environment variables as follows. If you cannot use the .env file, enter the Client ID obtained from the console in clientId of the App.js file.
