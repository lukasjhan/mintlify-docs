---
title: 'Vue Guides'
description: 'Vue를 사용해 Furo 로그인을 연동하는 방법을 안내합니다.'
icon: 'vuejs'
---

## 1. Git 저장소 다운로드

[Furo Vue Sample](https://github.com/lukasjhan/furo-sample-vue) 프로젝트를 다운로드 받습니다.
...
2. 콘솔 입력창의 Default Callback URI에 기본값 `https://sample.furo.one/{{YOUR_CLIENT_ID}}` 를 `http://localhost:8080/{{YOUR_CLIENT_ID}}` 로 변경합니다.
