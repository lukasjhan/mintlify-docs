---
title: 'OTP Auth'
api: 'POST /magic_links/authenticate'
...
<Warning>
  In response, property access_token and refresh_token is deprecated. Use
  **code** property instead.
</Warning>
...
```json Login Success
{
  ...
  "user_created": false,
  "code": "7983f6be1216fa6bfd2f0a16f94de19dcde6d232"
}
```
